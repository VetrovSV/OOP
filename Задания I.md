...
- Рекомендуемый стандарт кодирования:
  - <https://tproger.ru/translations/stanford-cpp-style-guide>
- Требования к выполнению заданий:
  - <https://github.com/VetrovSV/OOP/criteria.md>
...
3. Продемонстрируйте когда можно использовать динамический полиморфизм, а когда нельзя.
4. Приведите пример когда нужно использовать функцию dynamic_casts
...
1. Создать калькулятор с графическим интерфейсом пользователя.
   Калькулятор должен корректно обрабатывать любые входные данные.
   Помимо арифметических операций и возведения в любую степень,
   калькулятор должен вычислять функции:
   - $\sin$
   - $\cos$
   - $\tan$
   - $\ln$
   - $\exp$
2. Сделать обработку исключительных ситуаций.
3. Изобразить диаграмму классов (без указания методов и полей)

Дополнительно:

- хранить историю вычислений
- взаимодействие с интерфейсом без мыши
- разбирать математические выражения, например: `2 x 4 / (2 x 2)`
...
6. SOLID. Опишите принцип открытости/закрытости.
7. SOLID. Опишите принцип единственной ответственности.
8. Что такое фреймворк?
9. Какие возможности среды программирования использовались?
   - Автоматическая генерация методов, конструктора?
   - Рефакторинг?
   - Автоматическое изменение сигнатуры методов?
