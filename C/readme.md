...
float matr_max(float mat[N][M], unsigned n, unsigned m){
    ...
    // т.к. непонятно сколько эл-в нужно пропустить чтобы перейти к следующей строке, но можно указатьывать только кол-во элементов в строке float mat[][M]
...
2. Язык программирования С. Лекции и упражнения, Стив Прата, 6-е издание.
