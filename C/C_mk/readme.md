...
2. Понятие среды разработки (IDE) и её основные компоненты. Панели. Запуск и сборка. Режимы запуска и сборки.
    ...
    4. Минималистичная онлайн-IDE
      - с отладчиком (может быть недоступен в РФ): (https://www.onlinegdb.com/)[https://www.onlinegdb.com/]
      - без отладчика: (https://www.codechef.com/ide)[https://www.codechef.com/ide]
...
1. Цикл с предусловие и постусловием; Заголовок и тело цикла. Операторные скобки. Условие и его изменение в цикле. примеры: сумма ряда и работа со счётчиком; оптимизация вычислений с использованием предыдущего значения; ввод данных с проверкой; демонстрация выполнения циклов в отладчике; сумма ряда до заданной точности ε.
1. Частые ошибки: бесконечный цикл, = вместо ==
1. Цикл со счётчиком. Инкремент и декремент. Пример: Таблица квадратов чисел. Ошибки связанные с < и <=. Изменение шага.
1. Break. Continue. Пример с "бесконечным" циклом; обработка последовательного ввода (сумма вводимых значений).
1. Использование отладчика. *Логирование.*
1. *Примеры: нахождение произведения нескольких множителей*
1. Вложенные циклы. 
1. *Примеры: проверка ввода с условием, проверка ввода с циклом, численное интегрирование*

## 5. Массивы
1. Массивы. Размерность и измерения. Свойства массива. Индексация и доступ к элементам. 
1. Примеры: Ввод данных в массив и заполнение. Вывод данных из массива. 
