...
1. Цикл со счётчиком. Инкремент и декремент. Пример: Таблица квадратов чисел. Ошибки связанные с < и <=. Изменение шага. Частые ошибки: неправильные условия вида `<` вместо `<=` и наоборот. `;` вместо тела цикла; Неизменность переменной цикла.
1. *Примеры для циклов: нахождение произведения нескольких множителей*
