...
2. Понятие среды разработки (IDE) и её основные компоненты. Панели. Запуск и сборка. Режимы запуска и сборки.
    ...
    4. Минималистичная онлайн-IDE
      - с отладчиком: (https://www.onlinegdb.com/)[https://www.onlinegdb.com/ ]
      - без отладчика: https://www.codechef.com/ide
3. [Пример минимальной программы](../examples.md#hello-world)
  - Структура проаграммы: главная функция, где объявлять переменные, где писать операторы, как подключать модули.
