...
1. Массивы. Объявление. Тип массива с учётом размера. Размерность и измерения. Индексация и доступ к элементам. Типичный ошибки индексации. Копирование массивов. 
