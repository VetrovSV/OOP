...
1. Процедурное программирование. 
    ...
    - Передача аргументов по ссылке (указателю) и по значению. Const указатели. Передача статических и автоматических (VLA) массивов в функцию. Примеры: функция деления с остатком; вывод массива на экран.
