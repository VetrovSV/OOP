...
1. Цикл с предусловие и постусловием; Заголовок и тело цикла. Операторные скобки. Условие и его изменение в цикле. примеры: сумма ряда и работа со счётчиком; ввод данных с проверкой; демонстрация выполнения циклов в отладчике; сумма ряда до заданной точности ε.
