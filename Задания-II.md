...
или\
Разобраться в XAML\FXML и др. коде существующего приложения, написать поясняющие комментарии. Должны присутствовать:
...
Для создания инсталлятора использовать готовые инструменты. Как удалить программу используя установочный файл?
