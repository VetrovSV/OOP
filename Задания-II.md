...
[Требования к выполнению заданий](https://github.com/VetrovSV/OOP/blob/master/criteria.md)

Приводите ссылку на задание в исходном коде или readme.
...
- научиться создавать простые приложения с GUI с использованием актуальных GUI фреимворков;
- на уровне диаграммы классов изучить устройство программ с GUI;
- изучить некоторые подходы и приёмы к проектированию программ на уровне классов (паттерна ООП, принципы SOLID)
...
**Вопросы**
1. По каким параметрам стоит описывать язык?
1. Какие основные принципы ООП и как они реализованы в Java?
2. Что такое класс и объект в контексте Java? Что такое ссылочный тип?
3. Как различаются наследование и реализация интерфейсов?
4. Что такое полиморфизм и какие его формы поддерживает Java?
5. Как работает инкапсуляция и какие модификаторы доступа существуют?
6. Что такое абстрактный класс и когда его следует использовать?
8. Какие типы коллекций предоставляются в Java?
9. Как писать и запускать модульные тесты с JUnit?
10. Какие инструменты IDE рекомендуются для разработки Java‑приложений?
11. Как настроить проект с помощью Maven/Gradle для работы с GUI‑фреймворком?
12. Какие популярные GUI‑фреймворки доступны для Java?
...
- Диаграммы
  - Изобразите UML диаграмму классов
  - Изобразите C4 диаграмму[Хабр](https://habr.com/ru/articles/778726/) [youtube](https://www.youtube.com/watch?v=MGDNV5rEhW0) приложения, включая внешние сервисы.
...
#### Вопросы
1. См. вопросы из работы 1.
1. Что такое MCV \ MVVM? Какие классы относятся к каким частям программы?
1. Изобразите диаграмму классов для приложения. 
2. Объясните отношения между классами. 
...
5. Что такое интерфейс\абстрактный класс?

5. Что такое SOLID? Опишите каждый принцип.
6. Ваша лабораторная соблюдает принципы SOLID?
7. Объясните принципы SOLID. 
8. Что такое *инверсия зависимостей*?
8. Что такое *внедрение зависимостей*? Используется ли в вашей работе такой приём?
7. Что такое регулярное выражение? 
8. Какие есть особенности записи регулярных выражений в выбранном языке? Что такое escape последовательность? Что такое экранирование символов?
8. Что такое API?
9. Какие параметры работы с LLM сервером у вас есть? 
10. Что такое паттерн проектирования Стратегия? Как его можно использовать в вашей работе?
...
2. Объясните наблюдатель?
3. Как в вашей работе используется этот паттерн?
4. 
...
Сдавать можно после того, как выполнены обязательные работы.
