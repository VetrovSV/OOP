...
**Запуск в Ubuntu**\
ЗЗапустить jar файл можно непосредственно, как и любой другой исполняемый файл - по двойному клику.
...
Все комментарии записыватся строкой выше того, что они  комментируют.

Нет способа сделать Javadoc комментарий в той же строке, что и комментируемый код.


Наиболее часто ипользуемые теги
