...
**Включить подержку С++20** в Visual Studio: свойства проекта > Свойства конфигурации | C\C++ : Стандарт языка = Стандарт ISO C++20 (/std:c++20)

**Включить подержку С++20** в Qt Creator: 
