...
- бинарные файлы
- **
- обработка аргументов командной строки (argc, argv)
...
- **не обязательно** составьте карту памяти (mind map) 
