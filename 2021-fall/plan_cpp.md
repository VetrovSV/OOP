# Лекция 6
- Разбор теста:
  - обязательный возврат значения из функции?
  - return 0 в функции с ворзвращаемым типом int*
  - проект (в IDE) vs include
  - неожиданный места, где можно привести оператор присваивания
  - области видимости
  - исключения vs assert
  - массивы, указатели и звёздочки
- Ответы на вопросы по пройденым темам
- Конспекты в markdown и github
- ...
- 
...
- История развития C++, детальное сравнение C и C++, философия C++.
- **
- макросы (ну и хорошо)
...
- extern
- **
- продвинутая обработка исключений: генерация новых исключений во время обработки исключений, сложенные блоки try..catch, ограничения на исключения для функций, ...
- **
- статический массив array
- почти вся стандартная библиотека (отдельные темы будут рассмотрены позже)
- математическая часть (стандарты C++17 и поздние) стандартной библиотеки
