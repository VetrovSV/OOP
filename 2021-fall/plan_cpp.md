...
Откройте VisualStudio. Меню Средсва > командная строка > PowerShell для разработчика.
...
Имя выходного exe файла совпадает с именем первого файла исхожного кода, переданного компилятору.
