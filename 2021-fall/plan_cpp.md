...
- конспект: использование скомпилированных статических библиотек в VS 2019
  - что такое стиатечкая библиотека? Как её создать?
  - опишите подключение библиотеке на примере: https://github.com/VetrovSV/OOP/tree/master/2021-fall/static_lib
  - что выдаст функция foo()?
