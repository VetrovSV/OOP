# Занятие 2. Компиляция в коммандной строке и массивы.
...
- Установите на домашнем компьютере
  - Visaul Studio 2019 или более новую версию
  - Qt 6, для компилятора MinGW (GCC). если во время установки всё выбрали правильно, то размер устанавливаемых файлов должен быть более 6 Гб
