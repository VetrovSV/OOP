...
### Домашняя работа
- Конспект. Отладка в VS. Точки останова. Режимы выполнения. Просмотр значений переменных. Стек вызовов.
- Конспект. Файловая структура проекта.
- Установка компонентов VS. VS Installer > вкладка Рабочие нагрузки | Разработка классических приложений на C++
