...
### Домашняя работа
Конспекты. 
1. Отладка в VS. Точки останова. Режимы выполнения. Просмотр значений переменных. Стек вызовов.
2. Конспект. Файловая структура проекта.
3. Установка компонентов VS. VS Installer > вкладка Рабочие нагрузки | Разработка классических приложений на C++
