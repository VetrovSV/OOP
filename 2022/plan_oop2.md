...
Опишите принципы построения программы втаким UI в конспекте. Опишите основные элементы UI и их свойства. Опишите, как код на языке программирования общего назначения взаимодействует с UI.
