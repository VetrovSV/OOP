...
- Повторение. Проблемы использования фреймворка. Исключения. Динамический полиморфизм.
- dynamic_cast. Умные указатели.
- Иерархия классов Qt; Классы элементов интерфейса.
- Иерархия объектов Qt
- Преимущества ООП 

### Домашнее задание
- Конспект: Преобразование типов и операторы static_cast и dynamic_cast.
...
# Занятие 15
10 декабря
- Повторение: MVC, главный цикл обработки сообщений
- stl vs Qt. Прблема обезьяны, джунглей и банана.
- Компоновщики элементов пользовательского интерфейса.


Дополните программу с предыдущего занятия.
- Создайте класс, организующий вычисления. Подумайте, какие данные стоит хранить в классе и какие методы должны там быть.
Можно предложить свой вариант задачи, вместо задания из задачника.
- Сделайте проверку предусловий для вычислений. Сообщайте пользователю об ошибке. Не используйте диалоговые окна.
- Выводите отчёт о вычислениях в многострочное поле ввода. Поле ввода должно быть защищено от изменения пользователем. 
- Добавьте кнопку очистки поля ввода.
- Добавьте пункт меню программы: о разработчике.


**Домашнее задание (бонус)**
1. Создайте программу с графическим интерфейсом, на основе задания "Простой класс".
- Позвольте пользователю задавать значения для полей класса. Выполнять две или более операции с классом (вызывать методы). Отчёт о вызове методов или изменении полей записывайте в многострочное поле ввода QPlainText.
- Добавьте пункты меню для сохранения и загрузки данных класса. Используйте диалоговые окна.
2. Скачайте книгу Совершенный код. Стив Макконелл
...
**Домашнее задание**
- Скачайте рекомендуемую литературу по Qt
...
Скопируйте фреимворк Qt и IDE Qt Creator. На компьютерах аудиторий 400, 401, 404 см. папку: `C:\Qt`

Или используйте онлайн-инсталлятор OpenSource версии через с VPN с IP вне РФ. 
...
Примеры: 
- https://github.com/VetrovSV/OOP/tree/master/examples/Qt/example_qt0 -- пример с описанием компоновки элементов интерфейса
- https://github.com/VetrovSV/OOP/tree/master/examples/2020/lec_5_qt-project
...
1. Сделайте программу с графическим интерфейсом, на основе программы из [занятия 1](https://github.com/VetrovSV/OOP/blob/master/2022/plan_cpp.md#%D0%B7%D0%B0%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F).
 ...
 - напишите комментарии, поясняющие код
...
- Классы, повторение: избыточность, выравнивание памяти, инкапсуляция, вызов конструкторов. Тест через несколько недель. 
...
- *Бонус: реализуйте Метод Куайна—Мак-Класки для минимизации булевых функций. Используйте функциональную или объектно-ориентированную декомпозицию.*
