...
- Создание приложений в на Java с использованием фреимворка JavaFX в IntelliJ IDEA
    - Создание проекта, настройки, скачивание JDK
    - Обзор структуры проекта, файлов
    - Настройка конфигурации сборки и запуска
    - Настройка IntelliJ IDEA (окно настроек, окно универсального поиска 2x<kbd>Shift</kbd>)
...
[Задания-II.md](../Задания-II.md)


Выполните полностью за 2-4 недели.
...
- Интерфейсы Callable, Runnable, Function как инструменты для создания аналогов анонимных функций
  - https://github.com/VetrovSV/OOP/blob/master/examples/java/function-reference.md
