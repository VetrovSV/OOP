...
# Бонус: минимизации булевой функции
Создайте программу для минимизации булевой функции произвольного числа переменных.

Задавайте функцию через таблицу истинности. На ввод подавайте значения функции или список строк таблицы, для которых значения функции равно единице.
