...
1. Сделайте автоматическое тестирование программы с помощью макроса `assert`. Для функций, вычисляющий значений сделайте минимум три проверки. Рассмотрите крайние случаи. Напишите поясняюшие комментарии.
