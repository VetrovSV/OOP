...
4. Конспект по языку общего назначения (который выбрали для первого задания): Java, С#, свой вариант после согласования с преподавателем. Состав конспекта:
   ...
   - Шаблон консольного приложения, шаблон приложения c GUI. Код с пояснениями и файлы. Посянения к файлам.
   - Среда разработки. Создание проектов: консольный и с GUI. Рассматривайте акутальныеф фреимворки для GUI.
