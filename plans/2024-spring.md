...
# Занятие 3. 
29 февраля
Регулярные выражения. Многооконные приложения.
...
Сделайте шпаргалку о регулярных выражениях
   ...
   - использование в вашем любимом текстовом редакторе, примеры
...
#### Ссылки
- https://reqbin.com тестирование web-API
- https://github.com/public-apis/public-apis - Каталог сайтов с открытым API: 
