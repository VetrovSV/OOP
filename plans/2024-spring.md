...
3. Конспект по языку общего назначения (который выбрали для первого задания): Java, С#, свой вариант после согласования с преподавателем.
...
Сделайте шпаргалку о типе данных Словарь (ассоциативный массив) для выбранного языка программирования (C++, C#, Java). Используйте язык программирования, котоырй выбрали для реализации всех (или большинства) работ в этом семестре.


# Занятие 4. Шаблон модель-представление?
13 марта
0. Повторение. Регулярные выражения. Многооконные приложения. MVC. Отношения между классами. Абстрагирование. SOLID. Внедрение зависимостей.
1. Java. Итерфейсы. Интерфейс List и классы ArrayList, LinkedList.
1. Работа Чат-Бот. Варианты реализации. Список регулярных выражений. Список из указателей на функции.
1. Шаблон модель-представление?
